...
var Job = /** @class */ (function (_super) {
    ...
    ], Job.prototype, "jobTitle");
    __decorate([
        typeorm_1.Column()
    ], Job.prototype, "mission");
    __decorate([
        typeorm_1.Column({
            type: "date"
        })
    ], Job.prototype, "beginDate");
    __decorate([
        typeorm_1.Column({
            type: "date",
            "default": null
    ...
    __decorate([
        typeorm_1.ManyToOne(function (type) { return country_entity_1.Country; }, function (country) { return country.jobs; })
    ], Job.prototype, "country");
    __decorate([
        typeorm_1.OneToOne(function (type) { return company_entity_1.Company; }),
