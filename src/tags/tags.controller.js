...
var TagsController = /** @class */ (function () {
    ...
    TagsController.prototype.getAllTags = function () {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.tagsService.getAllTags()];
                    case 1:
                        tags = _a.sent();
    ...
    TagsController.prototype.deleteTag = function (tagId) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.tagsService.deleteTag(tagId)];
                    case 1: return [2 /*return*/, _a.sent()];
                }
            });
        });
    };
    TagsController.prototype.createTag = function (payload, tagImage) {
        return __awaiter(this, void 0, void 0, function () {
            var tag;
            return __generator(this, function (_a) {
                tag = JSON.parse(payload.tag);
                return [2 /*return*/, this.tagsService.saveTag(tag, tagImage)];
            });
        });
    };
    TagsController.prototype.editTag = function (payload, tagImage) {
        return __awaiter(this, void 0, void 0, function () {
            var tag;
            return __generator(this, function (_a) {
                tag = JSON.parse(payload.tag);
    ...
    ], TagsController.prototype, "deleteTag");
    __decorate([
        common_1.Post(),
    ...
    ], TagsController.prototype, "createTag");
    __decorate([
        common_1.Put(),
        common_1.UseInterceptors(platform_express_1.FileInterceptor('tagImage', {
            storage: multer_1.diskStorage({
        ...
        __param(0, common_1.Body()),
        __param(1, common_1.UploadedFile())
    ], TagsController.prototype, "editTag");
